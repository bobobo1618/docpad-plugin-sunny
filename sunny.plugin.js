...
(function() {
  ...
  module.exports = function(BasePlugin) {
    ...
    return docpadSunnyPlugin = (function(_super) {
      ...
      docpadSunnyPlugin.prototype.writeAfter = function(opts, next) {
        var cloudConfig, _i, _len, _ref1, _results;
        if (typeof next === "function") {
          next();
        }
        if ((!this.config.onlyIfProduction) || (process.env.NODE_ENV === "production")) {
          ...
          if (this.config.cloudConfigs.length > 0) {
            ...
            _ref1 = this.config.cloudConfigs;
            _results = [];
